...
//        String audioEnglish = RemoveSomeSamplesExample.class.getProtectionDomain().getCodeSource().getLocation().getFile() + "/count-video.mp4";
    	String audioEnglish = "/Users/stevedoubleday/Documents/workspaceMaven/mp4parser-read-only/examples/src/main/resources"  + "/count-video.mp4";

        Movie countVideo = MovieCreator.build(audioEnglish);

        //SJD subtitle apparently produces file QT can't read "Corrupted"
...
//        countVideo.addTrack(subTitleDeu);
        ...
        FileOutputStream fos = new FileOutputStream(new File("outputnosubtitle.mp4"));
